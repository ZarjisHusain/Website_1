...
<body>
<h1> Bachelor's Essential --> Household solution --> Water supply </h1>
	  ...
	  <a href = "http://localhost/myProject/laundry.php"style = "margin-left: 20px;"> Laundry </a>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM water WHERE area LIKE   '%$filtervalues%' ";
