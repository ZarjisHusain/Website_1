...
<html lang="en">
   <head>
      ...
      <!-- bootstrap css -->
      <link rel="stylesheet" href="cssg/bootstrap.min.css">
      <!-- style css -->
      <link rel="stylesheet" href="cssg/style.css">
      <!-- Responsive-->
      <link rel="stylesheet" href="cssg/responsive.css">
<link rel="stylesheet" href="cssg/main.css">
      <!-- fevicon -->
      <link rel="icon" href="images/fevicon.png" type="image/gif" />
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="cssg/jquery.mCustomScrollbar.min.css">
            ...
            <div class="row">
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="plants-box">
                     ...
                     <p>A passionate look, touch or a hug on a plant is enough to open your inner eyes than going for a serious yoga and other therapies</p>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                  <div class="plants-box">
